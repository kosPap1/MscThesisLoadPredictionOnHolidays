...
#
# #######################################################################################################################
MLPreg = MLPRegressor(hidden_layer_sizes=(74, 203),  random_state=1, activation='relu', solver='adam',
...
modelSVM = svm.SVR(kernel = 'rbf', C=46.0764, degree=4)
...
print('MAPE for Dormition of the Mother of God with XGBoost is ' + str(mean_absolute_percentage_error(y_pred, testY) * 100))
print('MAPE for Dormition of the Mother of God with MLP is ' + str(mean_absolute_percentage_error(y_pred_MLP, testY) * 100))
print('MAPE for Dormition of the Mother of God is ' + str(mean_absolute_percentage_error(y_predSVM, testY) * 100))
