...
loadTestLagMinus1 = load2019['2019-04-25']
loadTestLagMinus7 = load2019['2019-04-19']
loadTestLagMinus365 = load2018['2018-04-06']
tempTestDayTarget = temp2019['2019-04-26']
...
# Model training
model = xgb.XGBRegressor(base_score= 5.0,
             learning_rate = 0.7597199605102646,
             max_depth = 6,
             n_estimators= 50,
             reg_alpha= 0.034223507663340785,
             reg_lambda= 34.10663558911645,
             subsample= 1.0, booster='gbtree')
...
print('MAPE for Good Friday with XGBoost is ' + str(mean_absolute_percentage_error(y_pred, testY) * 100))
print('MAPE for Good Friday with MLP is ' + str(mean_absolute_percentage_error(y_pred_MLP, testY) * 100))
print('MAPE for Good Friday with SVM  is ' + str(mean_absolute_percentage_error(y_predSVM, testY) * 100))
