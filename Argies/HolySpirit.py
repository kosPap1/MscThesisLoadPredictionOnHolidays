...
# Lags creation
loadTrainLagTarget = load2009['2009-06-08']
loadTrainLagMinus1 = load2009['2009-06-07']
loadTrainLagMinus7 = load2009['2009-06-01']
loadTrainLagMinus365 = load2008['2008-06-16']
tempTrainDayTarget = temp2009['2009-06-08']

loadTestLagTarget = load2019['2019-06-17']
loadTestLagMinus1 = load2019['2019-06-16']
loadTestLagMinus7 = load2019['2019-06-10']
loadTestLagMinus365 = load2018['2018-05-28']
tempTestDayTarget = temp2019['2019-05-17']
...
# Model training
model = xgb.XGBRegressor(base_score= 0.1,
             learning_rate = 0.4333491136341146,
             max_depth = 1,
             n_estimators =500,
             reg_alpha = 0.13140210272996902,
             reg_lambda = 0.1,
             booster = 'gbtree')
...
MLPreg = MLPRegressor(hidden_layer_sizes=(256, 200, 82), random_state=1, activation='relu', solver='sgd',
                      early_stopping=True,
...
modelSVM = svm.SVR(kernel = 'linear', C=49.0964, degree=4)
...
print('MAPE for Holy Spirit with XGBoost is ' + str(mean_absolute_percentage_error(y_pred, testY) * 100))
print('MAPE for Holy Spirit with MLP is ' + str(mean_absolute_percentage_error(y_pred_MLP, testY) * 100))
print('MAPE for Holy Spirit is ' + str(mean_absolute_percentage_error(y_predSVM, testY) * 100))
