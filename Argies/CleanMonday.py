...
modelSVM = svm.SVR(kernel='rbf', C=6.76949353764, degree=4)
...
print('MAPE for Clean Monday with XGBoost is ' + str(mean_absolute_percentage_error(y_pred, testY) * 100))
print('MAPE for Clean Monday with MLP is ' + str(mean_absolute_percentage_error(y_pred_MLP, testY) * 100))
print('MAPE for Clean Monday with SVM is ' + str(mean_absolute_percentage_error(y_predSVM, testY) * 100))
