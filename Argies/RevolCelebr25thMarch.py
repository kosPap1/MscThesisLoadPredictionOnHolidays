...
from functions.dataInput import load2010, load2011, load2018, load2019, temp2011, temp2019
...
# Model training
model = xgb.XGBRegressor(base_score=4, learning_rate=1.83, max_depth = 4, n_estimators=320, reg_alpha=0.45104,
                         reg_lambda=45.01, booster='gbtree')
...
MLPreg = MLPRegressor(hidden_layer_sizes=(159, 233, 25), random_state=0, solver='adam', activation='relu',
...
modelSVM = svm.SVR(kernel='rbf', C=53.0964169, degree=2)
